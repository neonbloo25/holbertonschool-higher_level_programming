...
# 'lastD' trims number variable down to its last digit(preserves negative number status)
if number >= 0:
    lastD = number % 10
elif number < 0:
    lastD = number % -10
# This section prints the correct statement of "Last digit of 'xyz' is 'x' etc."
